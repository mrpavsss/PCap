...
- [X] Created new logo to go with new name
- [X] Changed action bar to include new name, Instagram logo and background
- [X] Changed login background to be the same as Instagram's
